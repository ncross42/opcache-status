...
if ( ! empty($_POST['reset']) ) {
	$ret = opcache_reset() ? 'SUCCESS' : 'FAILED';
	echo '<meta http-equiv="refresh" content="2;">';
	exit( "<h2> opcache_reset() : <font color='red'>$ret</font> </h2> <h3>refresh page after 2 seconds</h3>" );
}
	...
	<div id="container">
		...
		<div class="tabs">
			...
			<div class="tab">
				...
				<label for="tab-reset">Reset Opcache</label>
				<div class="content">
					<form method="POST">
						<input type="hidden" name="reset" value="1">
						<p><input type="submit" value="RESET Opcache"></p>
					</form>
				</div>
			</div>
